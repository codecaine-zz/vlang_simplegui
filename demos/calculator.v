...
fn main() {
	...
	gui.on_click('btn_0', fn (mut win simplegui.SimpleWindow) {
		press_digit(mut win, '0')
	})
	gui.on_click('btn_1', fn (mut win simplegui.SimpleWindow) {
		press_digit(mut win, '1')
	})
	gui.on_click('btn_2', fn (mut win simplegui.SimpleWindow) {
		press_digit(mut win, '2')
	})
	gui.on_click('btn_3', fn (mut win simplegui.SimpleWindow) {
		press_digit(mut win, '3')
	})
	gui.on_click('btn_4', fn (mut win simplegui.SimpleWindow) {
		press_digit(mut win, '4')
	})
	gui.on_click('btn_5', fn (mut win simplegui.SimpleWindow) {
		press_digit(mut win, '5')
	})
	gui.on_click('btn_6', fn (mut win simplegui.SimpleWindow) {
		press_digit(mut win, '6')
	})
	gui.on_click('btn_7', fn (mut win simplegui.SimpleWindow) {
		press_digit(mut win, '7')
	})
	gui.on_click('btn_8', fn (mut win simplegui.SimpleWindow) {
		press_digit(mut win, '8')
	})
	gui.on_click('btn_9', fn (mut win simplegui.SimpleWindow) {
		press_digit(mut win, '9')
	})

	gui.on_click('btn_add', fn (mut win simplegui.SimpleWindow) {
		press_op(mut win, '+')
	})
	gui.on_click('btn_sub', fn (mut win simplegui.SimpleWindow) {
		press_op(mut win, '-')
	})
	gui.on_click('btn_mul', fn (mut win simplegui.SimpleWindow) {
		press_op(mut win, '*')
	})
	gui.on_click('btn_div', fn (mut win simplegui.SimpleWindow) {
		press_op(mut win, '/')
	})
