...
fn main() {
	mut win := simplegui.new_simple_window('Batch Control Operations Demo', 600, 550)
	...
	win.on_click('btn_hide_pass', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_show_pass', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_toggle_vis', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_disable_inputs', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_enable_inputs', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_toggle_en', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_lock_all', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_unlock_all', fn (mut win simplegui.SimpleWindow) {
