...
fn main() {
	...
	mut win := simplegui.new_simple_window('List Sorting, Reordering & Live Search Demo',
		600, 650)
	win.add_search_field('search_box', 'Type to filter tasks...')
	win.add_vertical_spacer(10)
	win.add_list_box('task_list', tasks)
	win.bind_search_to_list('search_box', 'task_list')
	win.add_separator()

	win.begin_row('row_move')
	win.add_button('btn_up', 'Move Up')
	win.add_button('btn_down', 'Move Down')
	win.add_button('btn_sort_asc', 'Sort A-Z')
	win.add_button('btn_sort_desc', 'Sort Z-A')
	win.end_row()

	win.begin_row('row_edit')
	win.add_button('btn_insert', 'Insert Task')
	win.add_button('btn_update', 'Update Selected')
	win.add_button('btn_get_selected', 'Read Selection')
	win.end_row()

	win.begin_row('row_file')
	win.add_button('btn_save', 'Save to JSON')
	win.add_button('btn_load', 'Load from JSON')
	win.end_row()

	// --- Event Handlers ---

	// Move selected item UP by 1 slot
	win.on_click('btn_up', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_down', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_sort_asc', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_sort_desc', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_update', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_get_selected', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_load', fn (mut win simplegui.SimpleWindow) {
