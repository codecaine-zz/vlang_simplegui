...
fn main() {
	mut win := simplegui.new_simple_window('Form Controls Demo', 600, 700)
		...
		.add_form_dropdown('Country', 'country_select', ['USA', 'Canada', 'UK', 'Germany'],
			'USA')
	...
	win.on_click('btn_set', fn (mut win simplegui.SimpleWindow) {
