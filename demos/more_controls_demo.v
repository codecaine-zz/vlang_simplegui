...
fn main() {
	...
	win.add_banner('sys_status', 'All primary background microservices operating nominally with 99.99% uptime.', 'info')
	...
	win.begin_row('row_stat_cards')
		win.add_stat_card('stat_sales', 'Total Revenue', '$124,850', '+18.4% vs last week', 'success')
	...
	win.add_chip_group('env_chips', ['us-east-1', 'us-west-2', 'eu-central-1', 'ap-southeast-1'], 'us-east-1')
	...
	win.add_action_row({
		...
		'Simulate Alert': fn (mut w simplegui.SimpleWindow) {
			...
			w.set_avatar_card('card_user', 'Ada Lovelace', 'Incident Responder On-Call', 'Busy')
		}
	})
