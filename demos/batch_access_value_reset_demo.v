...
fn main() {
	mut win := simplegui.new_simple_window('Batch Value Access & Reset Helpers Demo',
		600, 650)
	...
	win.on_click('btn_trigger_errors', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_clear_errors', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_clear_specific', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_clear_all', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_reset_all', fn (mut win simplegui.SimpleWindow) {
