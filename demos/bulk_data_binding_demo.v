...
fn main() {
	mut win := simplegui.new_simple_window('Bulk Data Binding Demo', 550, 600)
	...
	win.on_click('btn_get_values', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_set_values', fn (mut win simplegui.SimpleWindow) {
		win.set_values({
			'username': 'john_doe'
			'age':      '35'
		})
	...
	win.on_click('btn_inspect', fn (mut win simplegui.SimpleWindow) {
	...
	win.on_click('btn_bind_struct', fn (mut win simplegui.SimpleWindow) {
